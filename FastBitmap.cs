...
{
    class FastBitmapp : IDisposable, ICloneable
    {
        ...
        public FastBitmapp(int width, int height) 
        {
            Init(width, height, 256, null, null);
        }

        public FastBitmapp(int width, int height, int levels)
        {
            bitmap = new Bitmap(width, height, PixelFormat.Format8bppIndexed);
            bitmap.SetResolution(bitmap.HorizontalResolution, bitmap.VerticalResolution);
            this.levels = levels;
        ...
        public FastBitmapp(FastBitmapp bmp)
        {
            if (bmp == null)
                throw new ArgumentNullException("bitmap");
        ...
        public FastBitmapp(FastBitmapp bmp, Rectangle src)
        {
            if (bmp == null)
                throw new ArgumentNullException("bitmap");
        ...
        {
            Unlock();
            FastBitmapp bmp = new FastBitmapp(this);
            Lock();            
            return bmp;
        }        
